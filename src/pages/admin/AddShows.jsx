...
const AddShows = () => {
  ...
  return nowPlayingMovies.length > 0 ? (
    <>
      ...
      <p className="mt-10 text-lg font-medium"> Now Plying Movies</p>
      <div className="overflow-x-auto pb-4">
        ...
        {nowPlayingMovies.map((movie)=>(
            ...
            {selectedMovie === movie.id &&( 
              <div className="absolute top-2 right-2 flex items-center justify-center bg-primary h-6 w-6 rouded">
