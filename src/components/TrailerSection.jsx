  ...
  return (
    <div className='px-6 md:px-16 lg:px-24 xl:px-44 py-20 overflow-hidden'>
        ...
        <div className='relative mt-6'>
            ...
            <ReactPlayer url={currentTrailer.videurl} controls={false} className="mx-auto max-w-full" width="960px" height="540px"/>
        </div>
        ...
        <div className='group grid grid-cols-4 gap-4 md:gap-8 mt-8 max-w-3xl mx-auto'>
              {dummyTrailer.map((trailer)=>(
                ...
                onClick={()=>setCurrentTrailer((trailer))}>
                    ...
                    <PlayCircleIcon strokeWidth={1.6} className="absolute top-1/2 left-1/2 w-5 md:w-8 h-5 md:h-12 trasform -translate-x-1/2 -translate-y-1/2"/>
                    </div>
              ))}
        </div>
